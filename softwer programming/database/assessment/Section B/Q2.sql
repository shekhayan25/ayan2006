-- Write SELECT queries using aggregate functions and GROUP BY to produce a restaurant-level revenue summary from order data.
--  Create an orders table with columns: order_id, restaurant_id, 
--  customer_name, total_amount, and order_date. 
--  Insert at least 12 orders distributed across at least 4 restaurants.
...
INSERT INTO orders (restaurant_id, customer_name, total_amount, order_date)
 VALUES (1, 'Ayan', 1800.00, '2026-09-01'), 
        (1, 'Rahul', 2200.00, '2026-09-03'), 
        (1, 'Priya', 1500.00, '2026-09-05'), 
        (2, 'Amit', 2500.00, '2026-09-02'),
        (2, 'Neha', 1800.00, '2026-09-06'),
        (2, 'Ravi', 1200.00, '2026-09-08'),
        (3, 'Karan', 3000.00, '2026-09-04'),
        (3, 'Meena', 2700.00, '2026-09-07'),
        (3, 'Jay', 1600.00, '2026-09-10'),
        (4, 'Pooja', 2000.00, '2026-09-09'), 
        (4, 'Vikas', 1800.00, '2026-09-11'),
        (4, 'Sneha', 2500.00, '2026-09-13');
