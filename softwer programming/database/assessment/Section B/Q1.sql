-- Create a structured schema for a food delivery 
-- system and populate it with sample data using DDL and DML commands.
-- Create a database named foodapp_db and a table named restaurants with columns: restaurant_id (INT, AUTO_INCREMENT, PRIMARY KEY),
--  name (VARCHAR, NOT NULL), city (VARCHAR), cuisine_type (VARCHAR), and rating (DECIMAL(3,1)).
