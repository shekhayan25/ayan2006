-- 1.
-- Create a table called Playlist with columns: id, song_name, artist, genre,
--  and play_count. Insert at least 5 sample records representing your favorite songs from Spotify.
